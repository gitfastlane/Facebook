...
public class AdminBoardCommand implements Command{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalCount = adao.countSearchBoard(start, end, month, year, searchText);
		int pageAmount = (int)(Math.ceil((double)totalCount/contentAmount));
		ArrayList<Fb_boardDTO> blist = adao.searchBoard(start, end, month, year, searchText, startPage, contentAmount);
