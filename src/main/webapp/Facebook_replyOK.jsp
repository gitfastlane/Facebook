...
<body>
			<!-- -----------댓글 상자------------ -->
                ...
                <!-- -----------댓글 입력------------ -->
                    ...
                    <form id="form_textarea${b_no_pk }" method="post" onsubmit="return sendReply(${b_no_pk });">
                    	<input type="hidden" name="b_groupNum" value="${b_no_pk }">
                        ...
                        <div class="textarea_textbox">
                            <textarea name="b_content" id="content${b_no_pk }" onkeydown="autoHeight(this)" onkeyup="autoHeight(this)" placeholder="댓글 추가..."></textarea>
                        </div>
                        <div class="textarea_submit"><input type="button" value="댓글" onclick="doForm(${b_no_pk }, ${b_no_pk }); return false;"></div>
                    </form>
                    </div>
                <!-- -----------댓글 입력 end------------ -->
                <!-- -----------댓글 내용------------ -->
                	<c:forEach var="rdto" items="${replyHM[b_no_pk] }">
                        ...
                        <div class="replyarea_textbox">
                            ...
                            <div class="textbox_write">
                                <div class="write_write">
                                    ...
                                    <c:forEach var="rrdto" items="${replyHM[b_no_pk] }">
                        			...
                        			<c:if test="${rdto.b_id_fk eq userID }">
                        			<a class="deleteReply" onclick="doDelete(${rdto.b_no_pk}, ${b_no_pk }); return false;">삭제</a>
                        			</c:if>
                                </div>
                            </div>
                         <!-- -----------답글 입력------------ -->
                            <div class="textbox_textarea" id="textarea${rdto.b_no_pk }">
                    		<form id="form_textarea${rdto.b_no_pk }" method="post" onsubmit="return sendReply(${rdto.b_no_pk });">
                    			<input type="hidden" name="b_groupNum" value="${b_no_pk }">
                        		...
                        		<div class="textarea_submit"><input type="button" value="댓글" onclick="doForm(${rdto.b_no_pk }, ${b_no_pk }); return false;"></div>
                    		</form>
                    		</div>
                    	<!-- -----------답글 입력 end------------ -->
                        </div>
                            ...
                            <div class="rereplyarea_textbox">
                                ...
                                <div class="textbox_write">
                                    <div class="write_write">
                                    	...
                                    	<a class="replyA" onclick="rereplyBoxOpen(${rrdto.b_no_pk})">답글</a>&nbsp
                                    	<c:if test="${rrdto.b_id_fk eq userID }">
                        				<a class="deleteReply" onclick="doDelete(${rrdto.b_no_pk}, ${b_no_pk }); return false;">삭제</a><br>
                        				</c:if>
                                    </div>
                                </div>
                            <!-- -----------답답글 입력------------ -->
                            	<div class="textbox_textarea" id="rereTextarea${rrdto.b_no_pk }">
                    			<form id="form_textarea${rrdto.b_no_pk }" method="post" onsubmit="return sendReply(${rrdto.b_no_pk });">
                    				<input type="hidden" name="b_groupNum" value="${b_no_pk }">
                    				<input type="hidden" name="b_stepNum" value="${rdto.b_no_pk }">
                    				<input type="hidden" name="b_indentNum" value="2">
                        			...
                        			<div class="textarea_submit"><input type="button" value="댓글" onclick="doForm(${rrdto.b_no_pk }, ${b_no_pk }); return false;"></div>
                    			</form>
                    			</div>
                    		<!-- -----------답답글 입력 end------------ -->
                            </div>
